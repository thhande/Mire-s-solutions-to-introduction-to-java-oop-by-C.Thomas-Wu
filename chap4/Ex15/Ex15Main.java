...
public class Ex15Main {
  ...
  public static void main(String[] args) {
    ...
    int large = bags / 20;
    bags %= 20;
    Bag largeBag = new Bag(large, 1.20);

    int medium = bags / 10;
    bags %= 10;
    Bag mediumBag = new Bag(medium, 1.00);

    int small = bags / 5;
    bags %= 5;
    Bag smallBag = new Bag(small, 0.60);
    ...
    double boxCost = largeBag.getBagPrice() + smallBag.getBagPrice() + mediumBag.getBagPrice();
